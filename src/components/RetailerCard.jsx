import '../styles/RetailerCard.css';

const RetailerCard = ({ retailer }) => {
  const { id, name, category, location, address, phoneNumber, distance } = retailer;
